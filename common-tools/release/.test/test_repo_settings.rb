...
describe ToysReleaser::RepoSettings do
  ...
  it "loads the toys repo settings" do
    ...
    assert_equal("toys-core", settings.default_component_name)
    ...
    assert_equal(["toys-core", "toys", "common-tools"], settings.all_component_names)
    assert_equal(["toys-core", "toys", "common-tools"], settings.all_component_settings.map(&:name))
