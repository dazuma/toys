...
describe ToysReleaser::Repository do
  ...
  it "finds a single merged Toys release pull request matching a SHA" do
    pr_info = repository.find_release_prs(merge_sha: "17ed449da8299f272b834470ff6b279a59e8070b")
    assert_equal(260, pr_info["number"])
  end
  ...
  it "creates a branch" do
    ...
    environment_utils.exec(["git", "switch", cur_branch], err: :null) if cur_branch
  end
end
