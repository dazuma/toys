...
describe ToysReleaser::RequestSpec do
  ...
  it "resolves default changes to Toys just before v0.15.6 tag" do
    ...
    assert_equal("toys-core", resolved_components[0].component_name)
    assert_equal(::Gem::Version.new("0.15.6"), resolved_components[0].version)
    core_changeset = resolved_components[0].change_set
    ...
    assert_equal("toys", resolved_components[1].component_name)
    assert_equal(::Gem::Version.new("0.15.6"), resolved_components[1].version)
    toys_changeset = resolved_components[1].change_set
