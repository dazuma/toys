...
module ToysReleaser
  ...
  class ComponentSettings
    ...
    def initialize(repo_settings, info, has_multiple_components)
      ...
      @pre_clean_dirs = Array(info["pre_clean_dirs"])
      @post_clean_dirs = Array(info["post_clean_dirs"])
    end
    ...
    ##
    # @return [Array<String>] A list of directories, under this component, to
    #     clean before build.
    #
    attr_reader :pre_clean_dirs

    ##
    # @return [Array<String>] A list of directories, under this component, to
    #     clean after release.
    #
    attr_reader :post_clean_dirs
