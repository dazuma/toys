...
module ToysReleaser
  ...
  class Performer
    ...
    def docs_already_exists?(component, version, result)
      dir = ::File.join(::File.expand_path(component.settings.gh_pages_directory, @gh_pages_dir), "v#{version}")
    ...
    def build_docs(component)
      return false unless component.settings.gh_pages_enabled
      component.cd do
    ...
    def copy_docs_dir(component, version)
      ...
      to_dir = ::File.join(::File.expand_path(component.settings.gh_pages_directory, @gh_pages_dir), "v#{version}")
    ...
    def update_docs_404_page(component, version)
      ...
      content.sub!(/#{component.settings.gh_pages_version_var} = "[\w.]+";/,
                   "#{component.settings.gh_pages_version_var} = \"#{version}\";")
