...
module ToysReleaser
  ...
  class Performer
    ...
    def gem_already_exists?(component, version, result)
      ...
      @utils.warn("Gem already pushed for #{component.name.inspect} #{version}. Skipping.")
    ...
    def docs_already_exists?(component, version, result)
      ...
      @utils.warn("Docs already published for #{component.name.inspect} #{version}. Skipping.")
    ...
    def tag_already_exists?(component, version, result)
      ...
      @utils.warn("GitHub release already exists for #{component.name.inspect} #{version}. Skipping.")
