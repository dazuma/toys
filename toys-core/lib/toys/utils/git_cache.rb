  ...
  module Utils
    ...
    class GitCache
      ...
      def copy_from_repo(repo_dir, into, sha, path)
        ...
        repo_path = ::Toys::Utils::GitCache.safe_join(repo_dir, path)
        unless ::File.exist?(repo_path)
          raise Error, "Path #{path.inspect} does not exist at SHA #{sha}"
        end
        into_path = ::Toys::Utils::GitCache.safe_join(into, path)
        if path == "."
    ...
    class GitCache
      ...
      #
      # This object is returned from {Toys::Utils::GitCache#repo_info}.
      #
      class RepoInfo
        include ::Comparable
      ...
      class SourceInfo
        ...
        def initialize(base_dir, sha, git_path, path_data)
          ...
          @source = ::Toys::Utils::GitCache.safe_join(root_dir, git_path)
    ...
    class GitCache
      ...
      class RepoLock
        ...
        #
        def lookup_ref(ref)
          return ref if ::Toys::Utils::GitCache.valid_sha?(ref)
