...
describe Toys::Release::Performer do
  ...
  let(:performer) { Toys::Release::Performer.new(repository, enable_prechecks: false, dry_run: true) }
  ...
  it "builds a report" do
    ...
    toys_result = Toys::Release::Performer::Result.new("toys", toys_version)
    toys_result.successes << "Toys success"
    core_version = repository.component_named("toys-core").current_changelog_version
    core_result = Toys::Release::Performer::Result.new("toys-core", core_version)
